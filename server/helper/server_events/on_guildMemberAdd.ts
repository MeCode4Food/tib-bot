...
import { welcomeID, rulesID, announcementsID, tourneyRulesID } from "../server_info/tib";

export function clientOnGuildMemberAdd(client: Client, newMembersChannelID: string) {
  client.on("guildMemberAdd", (member: GuildMember) => {
    ...
    if (process.env.ENV_MODE === "PROD") {
        ...
        (member.guild.channels.get(newMembersChannelID) as TextChannel).send(
